    ...
    <ul class="nav">
        ...
        <div class="profile-desc">
          <div class="profile-pic">
            ...
            <div class="profile-name">
              <h5 class="mb-0 font-weight-normal">Full name</h5>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item"> <a class="nav-link" href="admin/add_product">Add product</a></li> --}}
            <li class="nav-item"> <a class="nav-link" href="admin/view_products">List product</a></li>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic1">
          <ul class="nav flex-column sub-menu">
            {{-- <li class="nav-item"> <a class="nav-link" href="admin/product">List product</a></li>
            <li class="nav-item"> <a class="nav-link" href="admin/add_product">Add product</a></li> --}}
            <li class="nav-item"> <a class="nav-link" href="admin/view_categories">List Category</a></li>
         
            <li class="nav-item"> <a class="nav-link" href="admin/view_add_category">Add Category</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item menu-items">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="pages/icons/mdi.html">
          ...
          <span class="menu-title">Store Revenue</span>
        </a>
      </li>
